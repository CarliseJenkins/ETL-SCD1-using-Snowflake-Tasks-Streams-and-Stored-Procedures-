--  Create a customer target table to perform the required SCD1 logic using the stored procedure by executing it through a task. --
...
--Create a stored procedure to perform SCD1 logic in customer target table--
...
--Create a snow task to execute the above stored procedure--
...
--Alter the above created snowflake task to RESUME --
